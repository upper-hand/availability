require 'rspec'
require 'rspec/its'
require_relative '../lib/recurring_event'
...
describe RecurringEvent do
  ...
  describe '#initialize' do
    context 'daily frequency' do
      subject { RecurringEvent.new(duration_per_day: 15.minutes, interval: 3, start_time: Date.tomorrow) }

      its(:interval) { should eq(3) }
      its(:start_time) { should eq(Date.tomorrow.to_time) }
      its(:frequency) { should eq(:daily) }
      its(:duration_per_day) { should eq(15.minutes) }
    end

    context 'monthly frequency' do
      subject { RecurringEvent.new(duration_per_day: 2.hours, interval: 7, start_time: Date.tomorrow, frequency: :monthly) }

      its(:interval) { should eq(7) }
      its(:start_time) { should eq(Date.tomorrow.to_time) }
      its(:frequency) { should eq(:monthly) }
      its(:duration_per_day) { should eq(2.hours) }
    end

    context 'yearly frequency' do
      subject { RecurringEvent.new(duration_per_day: 30.minutes, interval: 2, start_time: Date.tomorrow, frequency: :yearly) }

      its(:interval) { should eq(2) }
      its(:start_time) { should eq(Date.tomorrow.to_time) }
      its(:frequency) { should eq(:yearly) }
      its(:duration_per_day) { should eq(30.minutes) }
    end
  end
  ...
  describe '#residue' do
    context 'when the frequency is daily' do
      context 'when interval is weekly' do
        it 'computes members of the residue class 0' do
          events = [
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 7.days),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 70.days)
          ]
        ...
        it 'computes members of the residue class 1' do
          events = [
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 1.day),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 8.days),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 71.days)
          ]
        ...
        it 'computes the complete residue system' do
          events = [
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 1.day),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 2.days),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 3.days),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 4.days),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 5.days),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 6.days),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 7.days)
          ]
      ...
      context 'when interval is every 100 days' do
        it 'computes members of the residue class 0' do
          events = [
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 100, start_time: beginning),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 100, start_time: beginning + 100.days),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 100, start_time: beginning + 500.days)
          ]
        ...
        it 'computes members of the residue class 25' do
          events = [
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 100, start_time: beginning + 25.day),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 100, start_time: beginning + 125.days),
            RecurringEvent.new(duration_per_day: 45.minutes, interval: 100, start_time: beginning + 525.days)
          ]
    ...
    context 'when the frequency is monthly' do
      context 'when interval is every 5 months' do
        it 'computes members of the residue class 0' do
          events = [
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning),
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning + 5.months),
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning + 20.months)
          ]
        ...
        it 'computes members of the residue class 1' do
          events = [
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning + 1.month),
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning + 6.months),
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning + 51.months)
          ]
        ...
        it 'computes the complete residue system' do
          events = [
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning),
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning + 1.month),
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning + 2.months),
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning + 3.months),
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning + 4.months),
            RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 5, start_time: beginning + 5.months)
          ]
  ...
  describe '#interval=' do
    it 'updates the residue when the interval changes' do
      event = RecurringEvent.new(duration_per_day: 45.minutes, interval: 30, start_time: beginning + 10.days)
      event.interval = 9
  ...
  describe '#occurs_at?' do
    context 'when the frequency is daily' do
      context 'when the event is biweekly and starts 5 days after the beginning' do
        let(:event) { RecurringEvent.new(duration_per_day: 45.minutes, interval: 14, start_time: beginning + 5.days) }
      ...
      context 'when the event is every 30 days and starts 11 days after the beginning' do
        let(:event) { RecurringEvent.new(duration_per_day: 45.minutes, interval: 30, start_time: beginning + 11.days) }
      ...
      it 'should process events of different intervals on the same day when applicable' do
        event_1 = RecurringEvent.new(duration_per_day: 45.minutes, interval: 10, start_time: beginning)
        event_2 = RecurringEvent.new(duration_per_day: 45.minutes, interval: 8, start_time: beginning + 2.days)
        event_3 = RecurringEvent.new(duration_per_day: 45.minutes, interval: 15, start_time: beginning + 5.days)
        event_4 = RecurringEvent.new(duration_per_day: 45.minutes, interval: 10, start_time: beginning + 5.days)

        common_date = Date.new(1970, 2, 20)
    ...
    context 'when the frequency is monthly' do
      context 'when the event is every 3 months and starts 2 months after the beginning' do
        let(:event) { RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 3, start_time: beginning + 2.months) }
    ...
    context 'when the frequency is yearly' do
      context 'and the event is every 2 years and starts at the beginning' do
        let(:event) { RecurringEvent.new(duration_per_day: 2.hours, frequency: :yearly, interval: 2, start_time: beginning + 1.year) }
  ...
  describe '#next_occurrence' do
    context 'when the frequency is daily' do
      context 'when the event is every 21 days and starts 2 days after the beginning' do
        let(:event) { RecurringEvent.new(duration_per_day: 45.minutes, interval: 21, start_time: beginning + 2.days) }
      ...
      context 'when the event is every 10 days and starts 4 days after the beginning' do
        let(:event) { RecurringEvent.new(duration_per_day: 45.minutes, interval: 10, start_time: beginning + 4.days) }
    ...
    context 'when the frequency is monthly' do
      context 'when the event is every 4 months and starts at the beginning' do
        let(:event) { RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 4, start_time: beginning) }
    ...
    context 'when the frequency is yearly' do
      context 'and the event is every 3 years and starts at the beginning' do
        let(:event) { RecurringEvent.new(duration_per_day: 2.hours, frequency: :yearly, interval: 4, start_time: beginning) }
  ...
  describe '#next_n_occurrences' do
    context 'when the frequency is daily' do
      context 'when the event is every 7 days and starts 31 days after the beginning' do
        let(:event) { RecurringEvent.new(duration_per_day: 45.minutes, interval: 7, start_time: beginning + 31.days) }
      ...
      context 'when the event is every 40 days and starts 11 days after the beginning' do
        let(:event) { RecurringEvent.new(duration_per_day: 45.minutes, interval: 40, start_time: beginning + 11.days) }
    ...
    context 'when the frequency is monthly' do
      context 'when the event is every 7 months and starts 3 months after the beginning' do
        let(:event) { RecurringEvent.new(duration_per_day: 45.minutes, frequency: :monthly, interval: 7, start_time: beginning + 3.months) }
